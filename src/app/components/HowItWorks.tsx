            ...
            {(["step1", "step2", "step3"] as const).map((key, i) => (
              ...
              >
                <div className="relative mb-6">
                  ...
                  <span className="absolute -right-2 -top-2 flex h-6 w-6 items-center justify-center rounded-full border border-white/10 bg-[#0a0a0a] text-[11px] font-semibold text-white/40">
                    {NUMBERS[i]}
                  </span>
                </div>
